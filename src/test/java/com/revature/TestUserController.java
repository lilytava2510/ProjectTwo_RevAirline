...
public class TestUserController {
    ...
    @Test
    @Transactional
    public void failedCreateUser() throws Exception{
        LinkedHashMap<String,String> registerBody = new LinkedHashMap<>();
        registerBody.put("email","@");
        registerBody.put("password","pass");
        registerBody.put("firstName","a");
    ...
    @Test
    @Transactional
    public void failedLoginUser() throws Exception{
        LinkedHashMap<String,String> registerBody = new LinkedHashMap<>();
        registerBody.put("email","@");
        registerBody.put("password","pass");

        User registeredUser = new User("@", "test", 3, 2, "a", "b", 101, true, 111);
        ur.save(registeredUser);

        MvcResult content = mockMvc.perform(post("/user/login").contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsString(registerBody))
    ...
    public void failedUpdateUser() throws Exception{
        ...
        User registeredUser = new User("@", "pass", 3, 2, "a", "b", 101, true, 111);
        ur.save(registeredUser);
        User secondUser = new User("#", "pass", 3, 2, "a", "b", 101, true, 111);
        ur.save(secondUser);
